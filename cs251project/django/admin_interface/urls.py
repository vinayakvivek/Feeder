...
urlpatterns = [
	...
	url(r'^student/courses/', views.student_courses, name='studentcourses'),
	url(r'^student/feedback/$', views.student_feedback, name='studentfeedback'),
	url(r'^student/feedback/submit/$', views.student_feedback_submit, name='studentfeedbacksubmit'),
